...
$\Tbe$, $\ximax$, and $\rhoc$ derived per node) has $377$ physical models---the
$277$ with $\rho_{\mathrm{BE}}(\Rbe)\ge\rhocloud$ plus the $100$ formerly
excluded by the continuity constraint, now retained
(Sect.~\ref{sec:continuity})---of which $\sim$260 clear the detectability floor.
The newly retained models populate the compact, massive corner at high column
that the constraint had removed. It encloses $\sim$96\% of the Aquila cores;
the $\sim$4\% outside lie beyond the BE family and are discussed in
Sect.~\ref{sec:floorcap}.}
