#!/usr/bin/env python
"""inject_config_v3_iso.py -- the isolated control of the blending pair.

Run with:
    python -B run_inject_v3.py inject_config_v3_iso

Identical to inject_config_v3.py in every setting, including RANDOM_SEED,
...
exec(open(os.path.join(_here, 'inject_config_v3.py')).read())
